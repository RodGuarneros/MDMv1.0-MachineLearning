...
@st.cache_data(hash_funcs={pymongo.database.Database: lambda _: None})
...
grafico2d3 = generar_grafico_2d3(input_datos, df_normalizado, dataset_complete, lugar_seleccionado=variable_seleccionada_municipio) # cambio
